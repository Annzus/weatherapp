...
const Searchweather = () => {
    ...
    useEffect(() => {
        const fetchWeather = async ()=> {
            const response = await fetch(`https://api.openweathermap.org/data/2.5/weather?q=${search},jp&appid=9c2a457576751f80eb458c9efe34323a`);
            if(componentMounted){
                    ...
                    <div className="col-md-4">
                        <div class="card text-white text-center border-0">
                            ...
                            <div class="card-img-overlay">
                                ...
                                <p class="lead fw-border mb-0">{data.weather[0].main}</p>
